...
public class ViewLeft extends LinearLayout implements ViewBaseAction {
	...
	private void init(Context context) {
		// 设置空间id为1
		this.setId(PAGE_FIRST);
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.choose_list1, this, true);
		...
		earaListViewAdapter = new TextAdapter(context, groups, R.color.choose_eara_item_press_color,
		...
		plateListViewAdapter = new TextAdapter(context, childrenItem, R.color.choose_eara_item_press_color,
